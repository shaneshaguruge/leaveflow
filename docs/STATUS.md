...
- Phase 10 — [me] reply to Nadeesha with the live link; [needs AWS] CloudWatch 5xx alarm and the snapshot restore drill; [me] ask Nadeesha whether overlapping leave should also *warn* or *block*; [me] staged incident.
